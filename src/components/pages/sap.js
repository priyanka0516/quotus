            ...
            <div className='container'>
                <div className='row'>
                    <div className='col-md-2'>
                        <div className='tool-text'> <img src={require('./../assets/eti.png')} alt="eti"/></div>
                    </div>
            ...
            <div className='container-fluid'>
                <div className='row'>
                    <div className='col-xl-7 col-lg-7 col-md-12 col-sm-12 col-xs-12'>
                        <div className='tool-text'>
                        <h3>Unlock the Power of Data with Talend ETL</h3>
        ...
        <div className="container">
            <div className="row">
                <div className="col-sm-12">
                     <div className="classes">
                    <h1 className="why-us">Our <span className="content-text"> Team</span></h1>
                    <div className="main-heading-domain-border-1 text-center">
                        <div></div>
                        <div></div>
                    </div>
                        <p className='team-sap'>Our dedicated team of data migration experts utilizes cutting-edge ETL tools, including Talend, to seamlessly transfer and transform your valuable data. With a passion for precision and a wealth of experience, our skilled professionals ensure a smooth transition of your data assets, minimizing disruptions and maximizing efficiency. We pride ourselves on delivering tailored solutions that meet your unique requirements, while maintaining data integrity and security at every step. Trust our team to streamline your data migration process, providing you with a reliable foundation for informed decision-making and business growth.</p>
                    </div>
                </div>
            </div>
        </div>
