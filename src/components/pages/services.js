            ...
            <div className="row">
                <div className="col-lg-10 offset-lg-1">
                    <div className="cta-content">
                        ...
                        <p>Quotus Software SolutIons, that has been offering best IT services to you. At Quotus, we go beyond helping businesses transform through technology. We accept the call to build what you need. Quotus have power to create great solutions and technology to implement it. Think of abstractions then code.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <div className="container">
      ...
      <div className="row2-container">
        <div className="box orange">
          ...
          <p className="inn-heading">We are a blockchain DApps company based in India that provides decentralized, secure applications for our clients.</p>
