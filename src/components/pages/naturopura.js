...
<>
    ...
    {/* <div className="section" id="our-classes">
        ...
        <section class="flutter-hr">
              <div className="container">
            <h3>Solutions for a diverse range of businesses</h3>
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <div class="flutter-healthcare" id="fadeInLeft">
                        <h5>User Module</h5>
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <div class="flutter-healthcare" id="fadeInUp">
                        <h5>Farmer Module</h5>
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <div class="flutter-healthcare" id="fadeInRight">
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <div class="flutter-healthcare" id="fade-right">
                ...
                <div class="col-sm-12 col-md-12 col-lg-4">
                    <div class="flutter-healthcare" data-aos="fade-left">
