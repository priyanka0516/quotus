...
return ( 
    <div >
    <div className="single-room" id="companyabout">
    ...
    <div className="section" id="about">
        <div className="container">
            <div className="row">
                <div className="col-lg-4 col-md-12 col-sm-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <img src={require('./../assets/why1.png')} className="rounded img-fluid d-block mx-auto" alt="App"/>
                </div>
                <div className="right-text col-lg-8 col-md-12 col-sm-12 mobile-top-fix">
                    <div className="left-heading">
                        ...
                        <div className="left-text" style={{display:'flex'}}>
                            <img src={require('./../assets/why02.png')} alt="why2" className="image" />
                            <p>Quotus Software Solutions Private Limited is a software product developing company where we endeavor on highly proficient, propitious and cost-effective software products. Quotus have highly skilled personnel's offering software products using the best innovative minds, skills and using cutting-edge technologies.</p>
                        </div>
                         <div className="left-text" style={{display:'flex'}}>   <img src={require('./../assets/why02.png')} alt="why2" className="image" />   <p> Quotus aspire to provide software solutions to all those are not having a digital presence. In a short period, Quotus Software Solutions Private Limited has developed a business relationship with reputed clients all over India.</p></div>
                </div>
            </div>
        </div>
    </div>
